...
text-red-500 hover:text-red-400
            ...
            {/* RIGHT: SUMMARY CARD */}
            <div
              className="flex flex-col rounded-3xl border border-gray-800/70 shadow-[0_4px_20px_rgba(0,0,0,0.45),]
  bg-black/15 p-6 space-y-5 "
    ...
    hover:shadow-[0_0_22px_rgba(34,197,94,0.5)]
    hover:bg-green-300
  ...
  "
                ...
                <button
                  ...
                  className="w-full py-2 rounded-full text-xs md:text-sm text-red-500  hover:border-red-400 hover:bg-red-500/20 hover:text-red-200 transition-all duration-200"
                >
                  Clear Entire Cart
                </button>
              </div>
